        ...
        <div class="flex-grow-1 mb-3 mx-2" style="max-width: 400px;">
            <div class="card animate__animated animate__backInUp">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editModal-{{$post->id}}">Edit</button>
                    @endif
                </div>
                <div class="card-body">
                    <p>{{$post->content}}</p>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal" wire:click="deletePost({{$post->id}})">Delete</button>
                    </div>
                </div>
            </div>
        </div>
